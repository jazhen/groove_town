...
ActiveStorage::Blob.connection.execute('ALTER SEQUENCE active_storage_blobs_id_seq RESTART WITH 1')
ActiveStorage::Attachment.destroy_all
ActiveStorage::Attachment.connection.execute('ALTER SEQUENCE active_storage_attachments_id_seq RESTART WITH 1')
...
seeds.each do |seed|
  ...
  puts
  puts
  puts "https://groove-town-seeds.s3-us-west-1.amazonaws.com/old_avatars/#{profile_pic_filename}"
  puts
  puts

  profile_pic_url = open("https://groove-town-seeds.s3-us-west-1.amazonaws.com/old_avatars/#{profile_pic_filename}")
  ...
  seed[:albums].each do |seed_album|
    ...
    puts
    puts
    puts "https://groove-town-seeds.s3-us-west-1.amazonaws.com/old_album-covers/#{filename}.jpg"
    puts
    puts

    album_art_url = open("https://groove-town-seeds.s3-us-west-1.amazonaws.com/old_album-covers/#{filename}.jpg")
