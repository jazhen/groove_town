      ...
      <div className="session-form-container">
        <div className="session-form__inner-container">
          <form className="session-form" onSubmit={this.handleSubmit}>
            <h1 className="session-form__header">Sign up</h1>
            <label className="session-form__email-label" htmlFor="email">
              <span className="session-form__email-title">Email address</span>
              <input
                type="text"
            ...
            <label
              ...
              <span className="session-form__username-title">Username</span>
              <input
                type="text"
